...
df = pd.read_csv('/Users/gowtham/Downloads/sixyears_newdata.csv', header = None, error_bad_lines=False)
...
df = df[[ 'Age in Years', 'Gender','Field SBP', 'Field HR', 'Field RR', 'RTS', 'Field GCS','Injury Severity Score','ED SBP','ED HR','ED RR','ED GCS','Levels']]
#print df.head()
#Dropping all the rows with null values
features = [ 'Age in Years', 'Gender','Field SBP', 'Field HR', 'Field RR', 'RTS', 'Field GCS','Injury Severity Score','ED SBP','ED HR','ED RR','ED GCS','Levels']
for x in features:
