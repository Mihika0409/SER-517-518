...
dataframe = pd.read_csv('CSV/Trauma Data.csv')
...
#
# df_1 = pd.read_csv('Level1.csv', names=['word', 'count'])
# num_words_1 = df_1['count'].sum()
# df_1['frequence'] = df_1['count']/num_words_1
# df_1.to_csv('Level1Freq.csv')
#
# df_2 = pd.read_csv('Level2.csv', names=['word', 'count'])
# num_words_2 = df_2['count'].sum()
# df_2['frequence'] = df_2['count']/num_words_2
# df_2.to_csv('Level2Freq.csv')
#
