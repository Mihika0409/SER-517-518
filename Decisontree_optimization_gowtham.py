...
# performing the k-fold cross validation to make sure the system is not overfitting and produces the best accuracies possible.

#.......cross validation for gini index using training data ......
